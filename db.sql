...
CREATE TABLE public.data_source (
    ...
    ten_nguon_du_lieu character varying(255) NOT NULL,
    duong_dan_file character varying(255),
    user_id integer,
    status_id integer,
...
--
-- Name: password_reset_tokens; Type: TABLE; Schema: public; Owner: hoangtv
--
...
ALTER TABLE public.password_reset_tokens OWNER TO hoangtv;

--
-- Name: password_reset_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: hoangtv
--
...
ALTER TABLE public.password_reset_tokens_id_seq OWNER TO hoangtv;

--
-- Name: password_reset_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hoangtv
--
...
CREATE TABLE public.product (
    ...
    phan_tram_chuyen_doi_mua_hang numeric(15,2),
...
CREATE TABLE public.product_group (
    ...
    source_id integer,
    phan_loai_theo character varying(50),
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    active boolean DEFAULT true
);
...
--
-- Name: password_reset_tokens id; Type: DEFAULT; Schema: public; Owner: hoangtv
--
...
--
-- Name: ads_group_status ads_group_status_ten_trang_thai_key; Type: CONSTRAINT; Schema: public; Owner: hoangtv
--

ALTER TABLE ONLY public.ads_group_status
    ADD CONSTRAINT ads_group_status_ten_trang_thai_key UNIQUE (ten_trang_thai);
...
--
-- Name: campaign_status campaign_status_ten_trang_thai_key; Type: CONSTRAINT; Schema: public; Owner: hoangtv
--

ALTER TABLE ONLY public.campaign_status
    ADD CONSTRAINT campaign_status_ten_trang_thai_key UNIQUE (ten_trang_thai);
...
--
-- Name: password_reset_tokens password_reset_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: hoangtv
--
...
--
-- Name: password_reset_tokens password_reset_tokens_token_key; Type: CONSTRAINT; Schema: public; Owner: hoangtv
--
...
ALTER TABLE ONLY public.data_source
    ADD CONSTRAINT data_source_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
--
-- Name: password_reset_tokens password_reset_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hoangtv
--
...
--
-- Name: product_group product_group_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hoangtv
--

ALTER TABLE ONLY public.product_group
    ADD CONSTRAINT product_group_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.data_source(source_id) ON DELETE CASCADE;
